 ...
 */
package com.xyz.resources.client.icons;
...
public interface Icons extends ImageBundle {
  ...
  @Resource("user_go.png")
  AbstractImagePrototype assign();
  ...
  @Resource("collapse-all.gif")
  AbstractImagePrototype item();
  
  @Resource("logistic-icon-add.png")
  AbstractImagePrototype logisticadd();
  
  @Resource("XLS.png")
  AbstractImagePrototype exportxls();
}
