...
public class TradeHis implements java.io.Serializable {
	...
	public TradeHis(int recId, String shop, String id, String operator,
			...
			String customerNeeds, String sndStyle, Double goodsCost,
			Double total, Double tradeValue, String rcvTime,
			Double postFee, String sndTime, Double postFee2,
			Double otherFee, Double rcvValue, String postId,
			...
			Double drawbackValue, Boolean bdrawback, Boolean bnoconfirm,
			String rcvOperator, String sndOperator, Double profit,
			String flag, String remark, String goodsList, String currency,
			Double rate, String packaging, Double packagingCost,
			Double weight, String rcvId, String country, String province,
			...
			Double priceDis, Integer printExpressChk, Boolean beq,
	...
	public Double getRcvValue() {
		return this.rcvValue;
	}

	public void setRcvValue(Double rcvValue) {
		this.rcvValue = rcvValue;
	}
