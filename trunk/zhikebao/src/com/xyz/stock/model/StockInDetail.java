...
public class StockInDetail implements java.io.Serializable {
	...
	public StockInDetail(int recId) {
		this.recId = recId;
	}

	public StockInDetail(int recId, String id, String goodsNo, String spec,
			String unit, BigDecimal count, String name, BigDecimal price,
			String reserved2, BigDecimal reserved3, BigDecimal money,
			String remark) {
		this.recId = recId;
		this.id = id;
