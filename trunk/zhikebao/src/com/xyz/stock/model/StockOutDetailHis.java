 ...
 * 出库单明细历史
 */
public class StockOutDetailHis implements java.io.Serializable {
	...
	public StockOutDetailHis() {
	}

	public StockOutDetailHis(int recId) {
		this.recId = recId;
	}

	public StockOutDetailHis(int recId, String goodsNo, String name,
