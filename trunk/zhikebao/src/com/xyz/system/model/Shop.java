 ...
 */
@Entity(name="shop") @Table(name="shops")
public class Shop extends BaseModel {
	...
	public Date getSynchrRefunTime() {
		return synchrRefunTime;
	}

	public void setSynchrRefunTime(Date synchrRefunTime) {
		this.synchrRefunTime = synchrRefunTime;
	}
