...
public class CusMainView extends LayoutContainer {
  ...
  private void createExpander() {
    ...
    */
    ...
    Button ctBtn = new Button(msg.create(), Customer.ICONS.add());
    ...
    toolBar.add(new Button(msg.delete(), Customer.ICONS.delete()));
    toolBar.add(new SeparatorToolItem());
    toolBar.add(new Button(msg.config(), Customer.ICONS.plugin()));
    cp.setTopComponent(toolBar);
    cp.setBottomComponent(pagingBar);

    cp.setIcon(Customer.ICONS.table());
