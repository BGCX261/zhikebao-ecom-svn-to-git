...
public class Bargain implements java.io.Serializable {
	...
	private BigDecimal postageRcv; //
	private BigDecimal postageSnd;
	...
	public Bargain(int recId, String tradeNo, Date date, String customerId,
			...
			BigDecimal postageRcv, BigDecimal postageSnd,
			BigDecimal goodsTotal, BigDecimal profit, String remark,
			String shop, String status, String operator, String tradeStyle,
			String id, BigDecimal weight, String curState,
			BigDecimal tradeValue, String priceSpec, String customerGrade) {
		this.recId = recId;
	...
	public BigDecimal getPostageRcv() {
		return this.postageRcv;
	}

	public void setPostageRcv(BigDecimal postageRcv) {
		this.postageRcv = postageRcv;
	}

	public BigDecimal getPostageSnd() {
		return this.postageSnd;
	}

	public void setPostageSnd(BigDecimal postageSnd) {
		this.postageSnd = postageSnd;
	}
