 ...
 * 
 * @see com.Shop.ejb.bean.TaobaoUser
 * @author sea
 */
...
public class UserService implements IUserService {
	...
	public List<Shop> findByProperty(String propertyName,
	...
	public List<Shop> findByAppKey(Object appKey,
		...
		return findByProperty(APP_KEY, appKey, rowStartIdxAndCount);
	}

	public List<Shop> findByAppSecret(Object appSecret,
			int... rowStartIdxAndCount) {
		return findByProperty(APP_SECRET, appSecret, rowStartIdxAndCount);
	}
	...
	public List<Shop> findByIsAuthorize(Object isAuthorize,
			int... rowStartIdxAndCount) {
		return findByProperty(IS_AUTHORIZE, isAuthorize, rowStartIdxAndCount);
	}
	...
	public List<Shop> findBySessionKey(Object sessionKey,
			int... rowStartIdxAndCount) {
		return findByProperty(SESSION_KEY, sessionKey, rowStartIdxAndCount);
	}
