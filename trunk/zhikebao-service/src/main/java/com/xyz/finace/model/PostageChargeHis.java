 ...
 * 邮资结算历史
 */
public class PostageChargeHis implements java.io.Serializable {
	...
	public PostageChargeHis() {
	}

	public PostageChargeHis(int recId) {
		this.recId = recId;
	}

	public PostageChargeHis(int recId, String tradeId, String tradeType,
