 ...
 * 收支历史
 */
public class InOutHis implements java.io.Serializable {
	...
	public InOutHis(int recId) {
		this.recId = recId;
	}

	public InOutHis(int recId, Date date, String type, BigDecimal money,
			...
			String shop, String customerType) {
		this.recId = recId;
		this.date = date;
		this.type = type;
		this.money = money;
